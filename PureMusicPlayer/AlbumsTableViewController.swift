...
class iTunesAlbumsTableViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    if let albumsQuery: [MPMediaItemCollection] = MPMediaQuery.albums().collections {
      albums = albumsQuery
    } else {
  ...
  */
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    if let titlesTableViewController: TitlesTableViewController = storyboard?.instantiateViewController(withIdentifier: "titlesTableViewController") as? TitlesTableViewController {
